...
export default function ProductionSection({ params }: { params: { sessionCode: string } }) {
  ...
  const section = assessmentSections?.[1]
    ...
    try {
      ...
      if (data?.success) {
        toast({
          ...
          description: 'Production workflow information saved successfully.',
        })
        router.push(`/assessment/${sessionCode}/financial`)
      } else {
        ...
        >
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="mt-8 flex justify-between">
              <Button
                onClick={() => router.push(`/assessment/${sessionCode}/profile`)}
                variant="outline"
