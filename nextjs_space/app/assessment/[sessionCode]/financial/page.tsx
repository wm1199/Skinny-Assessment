...
export default function FinancialSection({ params }: { params: { sessionCode: string } }) {
  ...
  const section = assessmentSections?.[2]
    ...
    try {
      ...
      if (data?.success) {
        toast({
          ...
          description: 'Financial visibility information saved successfully.',
        })
        router.push(`/assessment/${sessionCode}/technology`)
      } else {
        ...
        >
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="mt-8 flex justify-between">
              <Button
                onClick={() => router.push(`/assessment/${sessionCode}/production`)}
                variant="outline"
