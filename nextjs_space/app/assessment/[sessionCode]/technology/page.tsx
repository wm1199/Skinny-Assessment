...
export default function TechnologySection({ params }: { params: { sessionCode: string } }) {
  ...
  const section = assessmentSections?.[3]
    ...
    try {
      ...
      if (data?.success) {
        toast({
          ...
          description: 'Technology information saved successfully.',
        })
        router.push(`/assessment/${sessionCode}/sales`)
      } else {
        ...
        >
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="mt-8 flex justify-between">
              <Button
                onClick={() => router.push(`/assessment/${sessionCode}/financial`)}
                variant="outline"
